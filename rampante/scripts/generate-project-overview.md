# Generate PROJECT-OVERVIEW.md Script Instructions

## Workflow Execution

1. If exists `./scripts/generate-project-overview.sh` exists -> NOTIFY "generate-project-overview.sh file already exists! Moving on"
2. Else create the file  `./scripts/generate-project-overview.sh` from the markdown below
